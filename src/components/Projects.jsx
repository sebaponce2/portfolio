...
const Projects = () => {
    return ( 
        <div className="main-container">
            <h1 className="m-auto text-center text-uppercase pb-5 font-sans-pro" id="projects">Proyectos</h1>
            <h3 className="text-center pt-5 pb-5 font-rubik">Bakery Shop</h3>
