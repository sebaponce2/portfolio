    ...
    return ( 
        <>
            ...
            <div>
                ...
                <p className="text-center m-auto pb-5">El proyecto fue construido con las siguentes tecnologías: <span className="fw-bold">REACT, CSS, BOOTSTRAP, NODEJS, EXPRESS, MYSQL</span></p>
